...
def changeYaw(vehicle):
    vehicle.channels.overrides['4'] = 1300
    time.sleep(1)
    vehicle.channels.overrides['4'] = 1505
...
# print("Set Ch3 override to 1300 (dictionary syntax)")
# vehicle.channels.overrides = {'3':1250}
# print(" Channel overrides: %s" % vehicle.channels.overrides)

# time.sleep(2)

# threading.Thread(target=changeYaw,args=([vehicle])).start()
